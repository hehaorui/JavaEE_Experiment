...
public class DB {
	...
	static {
		...
		addMapping(1L,u1,"app01u1","localhost","/app01");
		addMapping(2L,u1,"app02u1","localhost","/app02");
		
		addMapping(1L,u2,"app01u2","localhost","/app01");
		addMapping(2L,u2,"app02u2","localhost","/app02");
	}
